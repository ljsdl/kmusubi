...
<<?php echo esc_attr( $entry_tag ); ?> id="post-<?php the_ID(); ?>" <?php post_class( apply_filters( 'lightning_article_outer_class', 'entry entry-full' ) ); ?>>
	...
	<div class="<?php lightning_the_class_name( 'entry-body' ); ?>">
		...
		<tr><th>店舗紹介</th><td class="text-right"><?php echo get_field('shop', $post->ID); ?> </td></tr>
		<tr><th>電話番号</th><td class="text-right"><?php echo get_field('phone', $post->ID); ?> </td></tr>
		<tr><th>営業時間</th><td class="text-right"><?php echo get_field('time', $post->ID); ?></td></tr>
		</table>
